...
SCRIPT_FIT=fit_simulated_thinned_ebpmf_wbg_init.sbatch
method=ebpmf_wbg2

datafile=../data/sim/sla_simulated.Rds
initfile_tmp=../output/fastTopics_fit/fit_sla_fastTopics
outputfile_tmp=../output/sim_thinned/fit_sla_simulated_thinned_${method}_init_truth
for i in {2..20}
do
  inputfile=${initfile_tmp}_k${i}.Rds
  outputfile=${outputfile_tmp}_k${i}.Rds
  sbatch ${SCRIPT_FIT} ${method} ${datafile} ${inputfile} ${outputfile}
done

datafile=../data/sim/sla_simulated_0.20.Rds
initfile_tmp=../output/fastTopics_fit/fit_sla_fastTopics
outputfile_tmp=../output/sim_thinned/fit_sla_thinned_simulated_thinned_0.20_${method}_init_truth
for i in {2..20}
do
  inputfile=${initfile_tmp}_k${i}.Rds
  outputfile=${outputfile_tmp}_k${i}.Rds
...
initfile_tmp=../output/fastTopics_fit/fit_sla_fastTopics
outputfile_tmp=../output/sim_thinned/fit_sla_thinned_simulated_thinned_0.10_${method}_init_truth
for i in {2..20}
do
  inputfile=${initfile_tmp}_k${i}.Rds
  outputfile=${outputfile_tmp}_k${i}.Rds
