---
title: "ebpmf_wbg_simulate_big_data2"
author: "zihao12"
date: "2020-10-23"
...
* In `ebpmf_wbg_simulate_big_data.Rmd` the data seems too hard to learn: the ampliying factor for key words/doc is 10, but for freq words/doc is 100. As a result, even starting from truth we get a model that completely ignores those weak signals from top words/doc. 

* This time I will make the amplifying factor the same for freq words/doc and top words/doc.

```{r set-up}
knitr::opts_chunk$set(message = FALSE, warning = FALSE, autodep = TRUE)
out_dir = "output/sim/v0.4.5/exper2"
```
