...
## Introduction
I  applied [pmf](https://github.com/stephenslab/ebpmf.alpha/blob/master/R/pmf.R) (with $k = 100$) to [SLA](https://zihao12.github.io/ebpmf_data_analysis/data_preprocessing_sla) dataset. let's see the results.
...
```{r load-model}
model = readRDS(sprintf("output/SLA/v0.4.5/sla_pmf_initLF50_K%d_maxiter%d.Rds", K, maxiter))
...
### t-SNE plots
```{r tsne-plot1, fig.width=10, fig.height=120}
...
```{r clustering-3, fig.width=5.5, fig.height=120}
