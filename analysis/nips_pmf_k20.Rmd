...
## Introduction
I  applied [pmf](https://github.com/stephenslab/ebpmf.alpha/blob/master/R/pmf.R) (with $k = 20$) to [nips](https://github.com/stephenslab/topics/prepare_nips_data.html) dataset. let's see the results.
