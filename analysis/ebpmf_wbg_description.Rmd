...
* In a simplifying case where $g_{L, k}$ has 3 components for close to/larger than/smaller than $1$, then we estimate the proportions of average/activated/de-activated samples in that topic. Similar interpretation for $g_{F, k}$. 
