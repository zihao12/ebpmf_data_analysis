...
* What I found:
    ...
    - The algorithm is susceptible to initialization. At least for `l0`, `f0`, if they are not initialized well, they do not change much in the iterated algorithm, and distort the structure in `L`, `F`. (Note that in larger dataset, gettinng a good initial estimate of `l0`, `f0` may be easy. Need more experiments on bigger data).
