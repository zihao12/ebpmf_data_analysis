...
## Introduction
I  applied [ebpmf_wbg](https://github.com/stephenslab/ebpmf.alpha/blob/master/R/ebpmf_wbg.R) (with $k = 20$) to [nips](https://github.com/stephenslab/topics/prepare_nips_data.html) dataset. let's see the results.
