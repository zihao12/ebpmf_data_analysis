...
I also show all topics here: [topics](https://zihao12.github.io/ebpmf_data_analysis/ebpmf.alpha_v0.4.2_show_topics.html)
...
The rank-1 model for `pmf`is a mean of row and column, ignoring the structures. This is in contrast to `svd` type methods (PCA itself is a greedy approach that achieves global optimality: the best rank-K approximation). 
